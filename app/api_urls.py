...
from app.api_views import create_organization, update_organization_profile, update_organization_password, patients_view, \
    ...
    activities_view, trace_contact, logout, patient_timeline_view
...
urlpatterns = [
    ...
    path("patients/<int:patient_id>/timelines/<int:timeline_id>/", patient_timeline_view, name="api-patient-timeline-detail"),
